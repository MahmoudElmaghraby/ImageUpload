...
public class Orders {
    ...
    public Orders(String OrderNo ,String orderNamePt, float orderPrice, String orderLocation, String orderPhone, String orderEmail, String orderPartNo, String orderNameUser, int orderQuantity, float orderDeliveryFee) {
