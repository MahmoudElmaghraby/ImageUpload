...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "com.mrpistonapp2.android.imageupload.NewAppWidget";
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (MainActivity.loggedIn == 0){
            ...
            mAppWidgetText.setText("New User");

        }else if (MainActivity.loggedIn == 1){

            mAppWidgetText.setText(MainActivity.loggedName);
