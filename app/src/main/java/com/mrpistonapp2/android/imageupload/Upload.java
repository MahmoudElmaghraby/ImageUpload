...
public class Upload {
    ...
    public Upload(String name, String mModel, String mSubModel, String mProvider, String mYear, String mPartNo, String mCat, float mBPrice, float mSPrice, float mProfit, String imageUrl , String mCountry , String nameAR) {
        this.name = name;
        this.mModel = mModel;
